...
public class comboScript : StateMachineBehaviour
{
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        {
            Controllers.instance.anim.Play("Punchanim");
        }

        else if (Controllers.instance.isAttacking)
        {
            Controllers.instance.anim.Play("UltiPunchAnim");
        }

        else if (Controllers2.instance.isAttacking)
        {
            Controllers2.instance.anim.SetBool("ComboContinue", true);
        }
    }
